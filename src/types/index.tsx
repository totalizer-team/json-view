...
export const SetComp: FC<
  PropsWithChildren<{ value: unknown; keyName: string | number }>
> = ({ value, keyName }) => {
...
export const TypeString: FC<TypeProps> = ({ children = '', keyName }) => {
  ...
  const type =
    isRender &&
    render({ ...reset, style }, { type: 'type', value: children, keyName });
  const child =
    isRender &&
    render(
      { ...reset, children: text, className: 'w-rjv-value' },
...
export const TypeTrue: FC<TypeProps> = ({ children, keyName }) => {
  ...
  const child =
    isRender &&
    render(
      { ...reset, children, className: 'w-rjv-value' },
      { type: 'value', value: children, keyName },
    );
  return (
    <Fragment>
...
export const TypeBigint: FC<
  { children?: BigInt } & Omit<TypeProps, 'children'>
> = ({ children, keyName }) => {
...
export const TypeUrl: FC<{ children?: URL } & Omit<TypeProps, 'children'>> = ({
  children,
  keyName,
}) => {
...
export const TypeDate: FC<
  { children?: Date } & Omit<TypeProps, 'children'>
> = ({ children, keyName }) => {
